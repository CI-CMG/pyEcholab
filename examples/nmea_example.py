...
print(gga_vlw_data['GGA']['nmea_object'][0])
...
print('  Lat:', gga_vlw_data['GGA']['nmea_object'][0].latitude)
print('  Lon:', gga_vlw_data['GGA']['nmea_object'][0].longitude)

#  and do the same for VLW
print(gga_vlw_data['VLW']['time'][0])
print(gga_vlw_data['VLW']['nmea_object'][0])
