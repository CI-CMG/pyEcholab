...
This test compares EK80 CW complex data from an EK80 WBT Mini deployed with
a 38/200 combi transducer where the 38 chanel has 3 sectors and the 200 has 1.
...
input_path = 'C:/EK80 Test Data/Saildrone/'

#  define the paths to the reference data files
raw_filename = 'SD_alaska_2019-Phase0-D20190516-T030157-0.raw'
...
for idx, sv_chan in enumerate(ev_Sv_filename):
    ...
    fig2 = plt.figure()
    plt.plot(ev_power_data[0], ev_power_data.range, label='Echoview', color='blue', linewidth=1.5)
    plt.plot(ek80_power[0], ek80_power.range, label='Echolab', color='red', linewidth=1)
