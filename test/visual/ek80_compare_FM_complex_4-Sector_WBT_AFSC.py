...
This test compares EK80 FM Complex data from an EK80 WBAT system with
...
ek80 = EK80.EK80()
ek80.read_raw(input_path + raw_filename) #, start_time=start_time, end_time=end_time)
