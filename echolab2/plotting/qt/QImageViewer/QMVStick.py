...
class QMVStick(QGraphicsItem):
    ...
    """
    QMVStick implements the individual vertical lines, aka "sticks" that comprise
    a stick plot used to represent the magnitude of a measurement along a transect.
    ...
    def __init__(self, location, magnitude, scale, angle=90.0, color=[220,10,10], thickness=2.0,
                 alpha=255, linestyle='=', view=None, parent=None, classname='', id='QMVStick'):
    ...
    def updateSelectionPolygon(self):
        ...
        #self.selectionPolygon = QPolygonF([self.stick.p1(), self.stick.p2()])
    ...
    def p1(self):
        return self.stick.p1()


    def p2(self):
        return self.stick.p2()
