...
#from numpy import empty, repeat, reshape, pi, log10
#from numpy import arange as np_arange

import numpy as np
#from echolab.util.unit_conversion import _calc_CSv

#from numpy import floating as dtype_float
...
def indexed_to_electrical_angle(data):
    '''
    Convert indexed angle data to electrical angle

    :param data:
    :type data:  numpy.ndarray
    '''
    return 180.0 / 128.0 * data


def electrical_to_indexed_angle(data):
    '''
    Convert electrical angle to raw indexed angle

    :param data:
    :type data:  numpy.ndarray
    '''
    return 128.0 / 180.0 * data


def indexed_to_physical_angle(data, sensitivity, offset):
    '''
    Convert indexed angle data to physical angle
    ...
    :type offset: float
    '''
    return 180.0 / 128.0 * data / sensitivity - offset


def physical_to_indexed_angle(data, sensitivity, offset):
    '''
    Convert physical angle to indexed angle
    ...
    return (data + offset) * sensitivity * 128.0 / 180.0


def electrical_to_physical_angle(data, sensitivity, offset):
    '''
    Convert electrical to physical angle
    ...
    return data / sensitivity - offset


def physical_to_electrical_angle(data, sensitivity, offset):
    '''
    Convert physical angle to electrical angle
    ...
    return (data + offset) * sensitivity
